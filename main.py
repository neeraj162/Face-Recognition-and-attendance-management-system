...
class FaceRecognition:
    ...
    def predictFromImage(self, imgpath):
        img = cv2.imread(self.testpath+'/'+imgpath)
...
if __name__=='__main__':
    obj = FaceRecognition()
    # obj.predictFromImage('x.jpg')
    obj.predictFromWebCam()
